...
df = pd.read_csv (r'C:\Users\jacob\Documents\Studie\Master\Afstudeerproject Papendal\Thesis\Python\CSVfiles\21-06-2021-meiden-U17.csv', sep = ',', encoding = "ISO-8859-1")  # using encoding to include ï of Loïs
...
TrainingVariables.to_excel('PythonOutputFemales.xlsx', index = False)

#%% append training variables to Excel Database file

book = load_workbook('DatabaseFemales.xlsx')
writer = pd.ExcelWriter('DatabaseFemales.xlsx', engine='openpyxl') 
writer.book = book    
